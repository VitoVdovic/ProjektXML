        ...
        <form action="" method="post" enctype="multipart/form-data">
                ...
                if (isset($_POST['submit'])) {
                    if (isset($_FILES['xmlFile'])) {
                        ...
                        if ($xml === false) {
                            echo "<div class='message error'>Error: Invalid XML file";
                            foreach (libxml_get_errors() as $error) {
                                echo "<br>{$error->message}";
                            }
                            echo "</div>";
                        } else {
                            echo "<div class='message success'>XML is valid</div>";
                        }
                    } else {
                        echo "<div class='message error'>Error: No XML file uploaded</div>";
                    }
                }
                ?>
        </form>
